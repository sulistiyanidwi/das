              ...
              <div class="form">
                <form class="form-validate form-horizontal" id="feedback_form" method="get" action="">
                  <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2">Bagian Sungai<span class="required">*</span></label>
                    <div class="col-lg-10">
                      <div class="btn-group">
                  ...
                  <div class="form-group ">
                    <label for="ccomment" class="control-label col-lg-2">Informasi</label>
                    <div class="col-lg-10">
